...
<body>
  <nav class="nav-wrapper teal" role="navigation">
    <div class="nav-wrapper container">
    <a id="logo-container" href="<?php echo base_url();?>" class="brand-logo">
    <img src="<?php echo base_url();?>asset/images/logo.png" height="60" width="110" >
    <span class="jdl_sekolah">Sekolah Swasta</span>
    </a>
