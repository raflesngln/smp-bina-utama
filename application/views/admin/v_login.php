...
<head>
    ...
    <!-- Remove Tap Highlight on Windows Phone IE -->
 	 ...
 	 <link rel="shortcut icon" href="<?php echo base_url();?>asset_admin/images/favicon.ico">
    ...
    <link rel="stylesheet" href="<?php echo base_url();?>asset_admin/assets/css/login_page.min.css" />
        ...
        <div class="md-card" id="login_card">
            <div class="md-card-content large-padding" id="login_form">
                <div class="login_heading">
                    <div class="user_avatar"><img src="<?php echo base_url();?>asset_admin/images/user.png" height="250" width="250"></div>
                </div>
                <form method="post" action="<?php echo base_url();?>Admin/cek_login">
...
<p style="color:red"><?php echo isset($message)?$message:'' ;?></p>
    ...
    <script src="<?php echo base_url();?>asset_admin/assets/js/pages/login.min.js"></script>
