...
<div class="uk-grid" >
 ...
 <div class="md-btn-group">
                                <a href="javascript:void(0)" class="md-btn md-btn-wave waves-effect waves-button md-btn-warning"  onclick="sort_siswa()" ><i class="material-icons md-color-brown-50 ">search</i>Sort</a>
                                <a href="javascript:void(0)" class="md-btn md-btn-wave waves-effect waves-button md-btn-warning"  onclick="cetak_siswa()"><i class="material-icons md-color-brown-50 ">print</i>Print</a>
