...
CREATE TABLE `pendaftaran` (
  ...
  `kk` text,
  `traskrip_nilai` text,
  `status_proses` enum('tunda','proses','selesai') DEFAULT 'tunda',
  `status_validasi` enum('proses','diterima','ditolak') DEFAULT 'proses',
  `status_pembayaran` enum('belum_lunas') DEFAULT 'belum_lunas',
  `validasi_oleh` varchar(10) DEFAULT NULL,
  PRIMARY KEY (`nomor_daftar`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

/*Data for the table `pendaftaran` */

insert  into `pendaftaran`(`nomor_daftar`,`id_calon`,`tgl_daftar`,`nama_lengkap`,`jenis_kelamin`,`berat`,`tinggi`,`golongan_darah`,`nik`,`agama`,`tempat_lahir`,`tgl_lahir`,`anak_ke`,`jumlah_bersaudara`,`tempat_tinggal`,`asal_sekolah`,`nama_ayah`,`nama_ibu`,`tgl_lahir_ayah`,`tgl_lahir_ibu`,`pendidikan_ayah`,`pendidikan_ibu`,`pekerjaan_ayah`,`pekerjaan_ibu`,`penghasilan_ayah`,`penghasilan_ibu`,`alamat_ayah`,`alamat_ibu`,`pass_photo`,`ijasah`,`kk`,`traskrip_nilai`,`status_proses`,`status_validasi`,`status_pembayaran`,`validasi_oleh`) values ('PSB20170800001','5','2017-08-16 03:57:48','Alan rohim','pria',43,343,'O','12121','islam','jakarta barata','2003-05-08',2,3,'ckg','SDN 1','budi','rriri',2010,2010,'s1','sma','karyawan','buruh',12000,20000,'jkt','srg','guru.png',NULL,NULL,NULL,'tunda','proses','belum_lunas',NULL),('PSB20170800002','8','2017-08-06 00:00:00','budi santoso','pria',34,54,'a','3533','kristen','regerhge','2004-03-01',3,5,'rthtrhrt','rhrthr',NULL,'rjrtjrtj',1945,1948,NULL,NULL,'hrjtyjtyj','tyhrtyhgrt',0,NULL,'jthrthrtdby','grhrthrthtrhrtjkt','15781400_941066006026614_6298853379173704100_n.jpg','','','','tunda','proses','belum_lunas',NULL);
...
insert  into `siswa`(`NIS`,`tgl_daftar`,`nama`,`jenis_kelamin`,`berat`,`tinggi`,`golongan_darah`,`nik`,`agama`,`tempat_lahir`,`tgl_lahir`,`anak_ke`,`jumlah_bersaudara`,`tempat_tinggal`,`asal_sekolah`,`nama_ayah`,`nama_ibu`,`tgl_lahir_ayah`,`tgl_lahir_ibu`,`pendidikan_ayah`,`pendidikan_ibu`,`pekerjaan_ayah`,`pekerjaan_ibu`,`penghasilan_ayah`,`penghasilan_ibu`,`alamat_ayah`,`alamat_ibu`,`pass_photo`,`ijasah`,`kk`,`traskrip_nilai`,`kelas`) values ('PSB20170800001','2017-08-16 03:57:48',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
